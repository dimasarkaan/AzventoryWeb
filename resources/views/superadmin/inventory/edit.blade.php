        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('superadmin.inventory.update', $sparepart) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-4" x-data="inventoryForm()">
                    ...
                    <div class="card p-6 overflow-visible">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input id="minimum_stock" class="input-field" type="number" name="minimum_stock" value="{{ old('minimum_stock', $sparepart->minimum_stock) }}" min="0" />
                            ...
                            <div>
                                ...
                                <input id="stock" class="input-field" type="number" name="stock" value="{{ old('stock', $sparepart->stock) }}" min="0" />
                    ...
                    @include('superadmin.inventory.partials.scan-modal')
                </div>
