        ...
        <div class="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-3xl shadow-2xl sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full border border-secondary-100 relative"
            ...
            <div class="px-6 py-4 max-h-[70vh] overflow-y-auto bg-secondary-50/30">
                ...
                <div class="mb-6 bg-white p-4 rounded-2xl border border-primary-100 shadow-sm">
                    ...
                    <form @submit.prevent="addLocation()" class="flex gap-2" novalidate>
                        <div class="relative flex-grow">
                            ...
                            <input type="text" 
                                   ...
                                   title="Nama lokasi harus 2-100 karakter, mengandung huruf, diawali huruf/angka, serta hanya berisi huruf/angka/spasi/simbol (.,&-)">
                        </div>
                        <button type="submit" 
                        ...
                        <template x-for="loc in locationsList" :key="loc.id">
                            <div class="bg-white p-4 rounded-2xl border border-secondary-100 shadow-sm hover:shadow-md transition-all group flex items-center justify-between gap-4"
                                ...
                                <div class="flex-grow min-w-0">
                                    ...
                                    <form x-show="editingId === loc.id" @submit.prevent="saveEdit(loc.id)" x-cloak novalidate>
