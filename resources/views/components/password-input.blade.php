...
<div x-data="{ show: false }" class="relative w-full">
    <input 
        ...
        @disabled($disabled) 
        {{ $attributes->merge(['class' => 'border-secondary-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm pr-10 w-full']) }}
    >
    <button 
        type="button" 
        @click="show = !show" 
    ...
    >
        ...
        <!-- Eye Off Icon (hidden when show is false) -->
