<div id="inventory-mobile-list" class="block md:hidden space-y-4">
    @if((auth()->user()->role === \App\Enums\UserRole::SUPERADMIN || (!request('trash') && auth()->user()->role === \App\Enums\UserRole::ADMIN)) && $spareparts->count() > 0)
    ...
    <!-- Mobile Pagination -->
    <div id="inventory-pagination-mobile" class="inventory-pagination-mobile mt-4">
        {{ $spareparts->links() }}
    </div>
</div>
