                ...
                <div class="sm:flex sm:items-start w-full">
                    <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <label for="scan_photo_input" class="w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 sm:text-sm cursor-pointer order-2 sm:order-none">
                                <span>Upload Foto</span>
                                <input type="file" id="scan_photo_input" class="hidden" accept="image/*" @change="handleFileUpload">
                            </label>
                        </div>
                    </div>
                </div>
