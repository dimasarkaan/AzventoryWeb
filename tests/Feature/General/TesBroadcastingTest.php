...
class TesBroadcastingTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_otorisasi_channel_privat_memblokir_role_yang_tidak_berwenang()
    {
        ...
        // Operator mencoba listen ke channel stock-approvals (Khusus Admin)
        ...
        // Admin mencoba listen ke channel stock-approvals
        $this->actingAs($admin)
            ->postJson('/broadcasting/auth', [
                'channel_name' => 'private-stock-approvals',
                'socket_id' => '1234.1234',
    ...
    public function test_pembaruan_inventaris_mendorong_event_yang_benar()
    {
        ...
        $response = $this->actingAs($superadmin)
            ->putJson(route('api.inventory.adjust-stock', $sparepart->uuid), [
                'type' => 'decrement',
