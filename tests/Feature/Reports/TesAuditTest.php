...
class TesAuditTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function indeks_inventaris_menggunakan_cache_untuk_dropdown()
    {
        Cache::shouldReceive('remember')
            ->times(11) // categories, brands, locations, categoryOptions, brandOptions, locationOptions, warna, satuan, nama, partNumbers, conditions
