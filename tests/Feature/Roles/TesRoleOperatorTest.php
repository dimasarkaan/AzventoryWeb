...
class TesRoleOperatorTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function operator_tidak_dapat_memperbarui_inventaris()
    {
        ...
        $response = $this->actingAs($this->operator)->put(route('inventory.update', $sparepart), $data);
        $response->assertStatus(403);
    }
    ...
    public function operator_tidak_dapat_menghapus_lunak_inventaris()
    {
        ...
        $response = $this->actingAs($this->operator)->delete(route('inventory.destroy', $sparepart));
        $response->assertStatus(403);
    }
    ...
    public function operator_tidak_dapat_memulihkan_inventaris()
    {
        ...
        $response = $this->actingAs($this->operator)->patch(route('inventory.restore', $sparepart->uuid));
        $response->assertStatus(403);
    }
    ...
    public function operator_tidak_dapat_menghapus_permanen_inventaris()
    {
        ...
        $response = $this->actingAs($this->operator)->delete(route('inventory.force-delete', $sparepart->uuid));
        $response->assertStatus(403);
    }
    ...
    {
        $sparepart = Sparepart::factory()->create();
        $response = $this->actingAs($this->operator)->get(route('inventory.show', $sparepart));
        $response->assertStatus(200);
    }
    ...
    {
        $sparepart = Sparepart::factory()->create();
        $response = $this->actingAs($this->operator)->get(route('inventory.edit', $sparepart));
        $response->assertStatus(403);
    }
    ...
    {
        $sparepart = Sparepart::factory()->create();
        $response = $this->actingAs($this->operator)->get(route('inventory.qr.download', $sparepart));
        $response->assertStatus(200);
    }
    ...
    public function operator_dapat_mencetak_qr_code()
    {
        ...
        $response = $this->actingAs($this->operator)->get(route('inventory.qr.print', $sparepart));
        $response->assertStatus(200);
    }
