...
class TesRoleAdminTest extends TestCase
{
    use RefreshDatabase;
    ...
    #[Test]
    public function admin_tidak_dapat_mengakses_laporan()
    {
    ...
    public function admin_dapat_memperbarui_inventaris()
    {
        ...
        $response = $this->actingAs($this->admin)->put(route('inventory.update', $sparepart), $data);
    ...
    #[Test]
    public function admin_tidak_dapat_menghapus_lunak_inventaris()
    {
        $sparepart = Sparepart::factory()->create();

        $response = $this->actingAs($this->admin)->delete(route('inventory.destroy', $sparepart));
    ...
    public function admin_tidak_dapat_memulihkan_inventaris()
    {
        ...
        $response = $this->actingAs($this->admin)->patch(route('inventory.restore', $sparepart->uuid));
        $response->assertStatus(403);
    }
    ...
    public function admin_tidak_dapat_menghapus_permanen_inventaris()
    {
        ...
        $response = $this->actingAs($this->admin)->delete(route('inventory.force-delete', $sparepart->uuid));
        $response->assertStatus(403);
    }
    ...
    public function admin_dapat_meminta_stok()
    {
        ...
        $response = $this->actingAs($this->admin)->post(route('inventory.stock.request.store', $sparepart), [
            'type' => 'masuk',
            'quantity' => 10,
    ...
    {
        $sparepart = Sparepart::factory()->create();
        $response = $this->actingAs($this->admin)->get(route('inventory.show', $sparepart));
        $response->assertStatus(200);
    }
    ...
    {
        $sparepart = Sparepart::factory()->create();
        $response = $this->actingAs($this->admin)->get(route('inventory.edit', $sparepart));
        $response->assertStatus(200);
    }
    ...
    {
        $sparepart = Sparepart::factory()->create();
        $response = $this->actingAs($this->admin)->get(route('inventory.qr.download', $sparepart));
        $response->assertStatus(200);
    }
    ...
    public function admin_dapat_mencetak_qr_code()
    {
        ...
        $response = $this->actingAs($this->admin)->get(route('inventory.qr.print', $sparepart));
        $response->assertStatus(200);
    }
    ...
    #[Test]
    public function admin_tidak_dapat_mengunduh_laporan()
    {
