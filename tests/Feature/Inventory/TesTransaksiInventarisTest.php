...
class TesTransaksiInventarisTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function memperbarui_sparepart_dan_mencatat_aktivitas()
    {
        ...
        $response = $this->actingAs($this->user)
            ->put(route('inventory.update', $sparepart), $updateData);
    ...
    public function memulihkan_sparepart_dan_mencatat_aktivitas()
    {
        ...
        $response = $this->actingAs($this->user)
            ->patch(route('inventory.restore', $sparepart->uuid));
    ...
    public function menghapus_permanen_sparepart_dan_mencatat_aktivitas()
    {
        ...
        $response = $this->actingAs($this->user)
            ->delete(route('inventory.force-delete', $sparepart->uuid));
