...
class CategoryManagementTest extends TestCase
{
    ...
    #[Test]
    public function superadmin_can_list_categories()
    {
    ...
    #[Test]
    public function superadmin_can_store_category()
    {
        $response = $this->actingAs($this->superadmin)
    ...
    #[Test]
    public function superadmin_can_rename_category_and_update_items()
    {
    ...
    #[Test]
    public function superadmin_cannot_delete_category_with_items()
    {
        Category::create(['name' => 'IC']);
    ...
    #[Test]
    public function superadmin_can_delete_empty_category()
    {
    ...
    #[Test]
    public function operator_cannot_manage_categories()
    {
