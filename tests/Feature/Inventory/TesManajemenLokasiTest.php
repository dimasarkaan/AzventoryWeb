...
class TesManajemenLokasiTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $location = Location::create(['name' => 'Tegal']);
        Sparepart::factory()->create(['location_id' => $location->id, 'name' => 'Bolt 1']);
        Sparepart::factory()->create(['location_id' => $location->id, 'name' => 'Bolt 2']);
        ...
        $this->assertEquals(2, Sparepart::where('location_id', $location->id)->count());
    }
    ...
    {
        $location = Location::create(['name' => 'Tegal']);
        Sparepart::factory()->create(['location_id' => $location->id]);
