...
class TesDashboardServiceTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function mengembalikan_snapshot_stok_dengan_benar()
    {
        ...
        $this->assertEquals(\App\Models\Brand::count(), $snapshots['totalBrands']);
        $this->assertEquals(\App\Models\Category::count(), $snapshots['totalCategories']);
    }
