    ...
    public function boot(): void
    {
        ...
        \Illuminate\Auth\Notifications\ResetPassword::toMailUsing(function ($notifiable, $token) {
            ...
            return (new \Illuminate\Notifications\Messages\MailMessage)
                ...
                ->line('Kami menerima permintaan untuk mengatur ulang kata sandi akun Azventory Anda.')
                ->action('Atur Ulang Kata Sandi', $resetUrl)
                ->line('Tautan atur ulang kata sandi ini akan kedaluwarsa dalam 60 menit.')
                ->line('**🛡️ Informasi**: Tautan ini dibuat khusus untuk Anda dan hanya bisa digunakan satu kali. Jika Anda tidak merasa melakukan permintaan ini, silakan abaikan email ini.')
                ->line('Jika tombol di atas tidak berfungsi, silakan salin dan tempel tautan berikut ke browser Anda:')
                ->line($resetUrl)
