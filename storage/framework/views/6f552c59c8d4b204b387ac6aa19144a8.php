            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                <div>
                    <div class="flex items-center gap-3">
                        ...
                        <?php else: ?>
                            <span class="badge badge-secondary"><?php echo e(ucfirst($borrowing->status)); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="flex items-center gap-2 mt-1.5 text-secondary-500 text-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        Dipinjam: <?php echo e($borrowing->borrowed_at ? $borrowing->borrowed_at->translatedFormat('d F Y H:i') : '-'); ?>

                    </div>
                </div>
                <div class="flex items-center gap-2">
                    <a href="<?php echo e(route('inventory.show', $borrowing->sparepart)); ?>" class="btn btn-secondary">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            <div class="w-16 h-16 rounded-full bg-secondary-200 overflow-hidden flex-shrink-0">
                                <?php if($borrowing->user && $borrowing->user->avatar): ?>
                                    <img src="<?php echo e(asset('storage/' . $borrowing->user->avatar)); ?>" class="w-full h-full object-cover" loading="lazy" alt="<?php echo e($borrowing->user->name); ?>">
                                <?php else: ?>
                            ...
                            <div class="flex flex-col">
                                <span class="text-lg font-semibold text-secondary-900"><?php echo e($borrowing->user->name ?? 'User Terhapus'); ?></span>
                                <span class="text-sm text-secondary-500"><?php echo e($borrowing->user->role ?? '-'); ?></span>
                                <?php if($borrowing->user && $borrowing->user->email): ?>
                                    <span class="text-xs text-secondary-400 mt-1"><?php echo e($borrowing->user->email); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-base text-secondary-900 font-medium mt-1"><?php echo e($borrowing->sparepart->name); ?></p>
                                <p class="text-xs text-secondary-500 font-mono"><?php echo e($borrowing->sparepart->part_number); ?></p>
                            </div>

                            <div>
                                <span class="text-xs text-secondary-400 uppercase tracking-wider font-semibold">Total Dipinjam</span>
                                <p class="text-base text-secondary-900 font-bold mt-1"><?php echo e($borrowing->quantity); ?> <?php echo e($borrowing->sparepart->unit); ?></p>
                            </div>

                            <?php if($borrowing->remaining_quantity !== null): ?>
                                <div>
                                    <span class="text-xs text-secondary-400 uppercase tracking-wider font-semibold">Sisa Belum Dikembalikan</span>
                                    <p class="text-base <?php echo e($borrowing->remaining_quantity > 0 ? 'text-warning-600' : 'text-success-600'); ?> font-bold mt-1">
                                        <?php echo e($borrowing->remaining_quantity); ?> <?php echo e($borrowing->sparepart->unit); ?>
                            ...
                            <div>
                                ...
                                <p class="text-base text-secondary-900 font-medium mt-1">
                                    <?php echo e($borrowing->borrowed_at ? $borrowing->borrowed_at->translatedFormat('d F Y H:i') : '-'); ?>

                                </p>
                            </div>

                            <?php if($borrowing->expected_return_at): ?>
                                <div>
                                    <span class="text-xs text-secondary-400 uppercase tracking-wider font-semibold">Estimasi Kembali</span>
                                    <p class="text-base text-secondary-900 font-medium mt-1">
                                        <?php echo e(\Carbon\Carbon::parse($borrowing->expected_return_at)->translatedFormat('d F Y')); ?>
                            ...
                            <?php if($borrowing->notes): ?>
                                <div>
                                    ...
                                    <p class="text-sm text-secondary-600 mt-1"><?php echo e($borrowing->notes); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>

                        <?php if($borrowing->remaining_quantity > 0): ?>
                            <div class="mt-6 pt-4 border-t border-secondary-100">
                                <button
                                    @click="initReturn({ maxQty: <?php echo e($borrowing->remaining_quantity); ?>, borrowingId: <?php echo e($borrowing->id); ?> })"
                ...
                <div class="lg:col-span-2">
                    <div class="card p-6">
                        ...
                        <?php if($borrowing->returns->isEmpty()): ?>
                            <!-- Empty State -->
                        ...
                        <?php else: ?>
                            <!-- Timeline -->
                            <div class="space-y-6">
                                <?php $__currentLoopData = $borrowing->returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative pl-8 pb-6 border-l-2 border-secondary-200 last:pb-0 last:border-l-0">
                                        ...
                                        <div class="absolute -left-2 top-0 w-4 h-4 rounded-full"
                                             :class="getItemColor('<?php echo e($return->condition); ?>')">
                                        </div>
                                        ...
                                        <div class="bg-secondary-50 rounded-lg p-4 ml-2">
                                            <div class="flex items-start justify-between mb-3">
                                                <div class="flex-1">
                                                    <p class="text-sm font-semibold text-secondary-900 flex items-center gap-2">
                                                        ...
                                                        <?php echo e($return->return_date ? $return->return_date->translatedFormat('d F Y H:i') : '-'); ?>

                                                    </p>
                                                </div>
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold"
                                                      :class="getBadgeColor('<?php echo e($return->condition); ?>')">
                                                    <?php if($return->condition === 'good'): ?> Baik
                                                    <?php elseif($return->condition === 'bad'): ?> Rusak
                                                    <?php elseif($return->condition === 'lost'): ?> Hilang
                                                    <?php else: ?> <?php echo e(ucfirst($return->condition)); ?>
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                                                <div>
                                                    ...
                                                    <p class="text-lg font-bold text-secondary-900"><?php echo e($return->quantity); ?> <?php echo e($borrowing->sparepart->unit); ?></p>
                                                </div>
                                            </div>
                                            ...
                                            <?php if($return->notes): ?>
                                                <div class="mb-3">
                                                    ...
                                                    <p class="text-sm text-secondary-700 mt-1"><?php echo e($return->notes); ?></p>
                                                </div>
                                            <?php endif; ?>

                                            <!-- Photos Gallery -->
                                            <?php if($return->photos && count($return->photos) > 0): ?>
                                                <div>
                                                    <span class="text-xs text-secondary-500 font-semibold mb-2 block">Foto Bukti</span>
                                                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                                        <?php $__currentLoopData = $return->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <a href="<?php echo e(asset('storage/' . $photo)); ?>" target="_blank" class="group relative aspect-square rounded-lg overflow-hidden bg-secondary-200 hover:ring-2 hover:ring-primary-500 transition-all">
                                                                <img src="<?php echo e(asset('storage/' . $photo)); ?>" alt="Return Evidence" class="w-full h-full object-cover group-hover:scale-105 transition-transform">
...
<?php endif; ?>
<?php /**PATH E:\KULI AH\Semester\Semester 8\Tugas Akhir\Web 2\AzventoryWeb\resources\views/inventory/borrow/show.blade.php ENDPATH**/ ?>