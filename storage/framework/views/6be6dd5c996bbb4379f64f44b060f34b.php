        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <h2 class="text-3xl font-bold text-secondary-900 tracking-tight">
                    <?php echo e(__('ui.reports_center')); ?>

                </h2>
                <p class="mt-1 text-sm text-secondary-500"><?php echo e(__('ui.reports_desc')); ?></p>
            </div>

            <!-- Main Form Card -->
            <div>
                <form action="<?php echo e(route('reports.download')); ?>" method="GET" class="bg-white rounded-xl border border-secondary-200 shadow-card p-6 overflow-visible" x-data="{ reportType: 'inventory_list', period: 'this_month' }">
                    <?php echo csrf_field(); ?>
                    
                    <!-- Report Categories -->
                    <div class="mb-8">
                        <label class="block text-sm font-bold text-secondary-900 mb-4"><?php echo e(__('ui.choose_report_type')); ?></label>
...
<?php endif; ?>
                    ...
                    <div class="border-t border-secondary-200 pt-6">
                        <h3 class="text-sm font-bold text-secondary-900 mb-4 uppercase tracking-wide"><?php echo e(__('ui.filter_configuration')); ?></h3>
                        ...
                        <div class="mb-4 relative" x-show="['stock_mutation', 'borrowing_history'].includes(reportType)" x-transition>
                            <label class="block text-sm font-medium text-secondary-700 mb-2"><?php echo e(__('ui.time_period')); ?></label>
                            <input type="hidden" name="period" :value="period">
                            
                            <div x-data="{ 
                                open: false, 
                                labels: {
                                    'this_month': '<?php echo e(__('ui.this_month')); ?>',
                                    'last_month': '<?php echo e(__('ui.last_month')); ?>',
                                    'this_year': '<?php echo e(__('ui.this_year')); ?>',
                                    'all': '<?php echo e(__('ui.all_time')); ?>',
                                    'custom': '<?php echo e(__('ui.custom_date')); ?>'
                                }
                            }">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4" x-show="period === 'custom' && ['stock_mutation', 'borrowing_history'].includes(reportType)" x-transition>
                            <div>
                                <label class="block text-xs text-secondary-500 mb-1"><?php echo e(__('ui.start_date')); ?></label>
                                <input type="date" name="start_date" class="input-field w-full">
                            </div>
                            <div>
                                <label class="block text-xs text-secondary-500 mb-1"><?php echo e(__('ui.end_date')); ?></label>
                        ...
                        <div class="mb-4" x-data="{ 
                            open: false, 
                            selected: '<?php echo e(request('location')); ?>', 
                            selectedLabel: '<?php echo e(request('location') ? request('location') : __('ui.all_locations')); ?>',
                            select(value, label) {
                                this.selected = value;
                            ...
                            <label class="block text-sm font-medium text-secondary-700 mb-2"><?php echo e(__('ui.warehouse_location')); ?></label>
                            ...
                            <div class="relative">
                                ...
                                <div x-show="open" 
                                    ...
                                    <div class="max-h-60 overflow-y-auto p-2 space-y-1">
                                        <!-- Default Option -->
                                        <div @click="select('', '<?php echo e(__('ui.all_locations')); ?>')" 
                                            ...
                                            <?php echo e(__('ui.all_locations')); ?>

                                        </div>
                                        
                                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div @click="select('<?php echo e($loc); ?>', '<?php echo e($loc); ?>')" 
                                                    ...
                                                    :class="{'bg-primary-50 text-primary-700 font-medium': selected === '<?php echo e($loc); ?>'}">
                                                <?php echo e($loc); ?>
                            ...
                            <p class="text-xs text-secondary-400 mt-1 italic"><?php echo e(__('ui.location_placeholder_desc')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="bg-secondary-50 -mx-6 -mb-6 p-6 mt-8 rounded-b-lg flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-secondary-100">
                        <div class="flex items-center space-x-6">
                            <span class="text-sm font-medium text-secondary-700"><?php echo e(__('ui.format_label')); ?></span>
                                ...
                                <span class="ml-2 text-sm text-secondary-700 font-medium"><?php echo e(__('ui.pdf_document')); ?></span>
                            </label>
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="export_format" value="excel" class="text-success-600 focus:ring-success-500 h-4 w-4 border-gray-300">
                                <span class="ml-2 text-sm text-secondary-700 font-medium"><?php echo e(__('ui.excel_document')); ?></span>
                            </label>
                        </div>
                        <button type="submit" class="btn btn-primary px-8 py-3 text-base flex items-center gap-2 shadow-lg shadow-primary-200">
                            ...
                            <span><?php echo e(__('ui.download_report')); ?></span>
                        </button>
                    </div>
                </form>
            </div>
...
<?php endif; ?>
<?php /**PATH E:\KULI AH\Semester\Semester 8\Tugas Akhir\Web 2\AzventoryWeb\resources\views/reports/index.blade.php ENDPATH**/ ?>