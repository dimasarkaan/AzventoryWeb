        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-secondary-500"><?php echo e(__('ui.user_management_desc')); ?></p>
                </div>
                <div class="flex items-center gap-3">
                    <?php if(request('trash')): ?>
                        <a href="<?php echo e(route('users.index')); ?>" class="btn btn-danger p-2.5 rounded-lg flex items-center justify-center" title="<?php echo e(__('ui.back')); ?>">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('users.index', ['trash' => 'true'])); ?>" class="btn btn-white bg-white p-2.5 shadow-sm border border-secondary-200 text-secondary-600 hover:bg-secondary-50 rounded-lg" title="<?php echo e(__('ui.view_trash')); ?>">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                        </a>
                        <a href="<?php echo e(route('users.create')); ?>" class="btn btn-primary flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                            <?php echo e(__('ui.add_user')); ?>
            ...
            <?php if(request('trash')): ?>
                <div class="rounded-lg border border-danger-200 bg-danger-50 p-4 mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="font-medium text-danger-900"><?php echo e(__('ui.trash_mode')); ?></h3>
                            <p class="text-sm text-danger-700 mt-1"><?php echo e(__('ui.trash_mode_desc')); ?></p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
                     ...
                     <div class="mb-4 flex flex-col md:flex-row gap-4 items-center justify-between transition-all duration-300">
                        <div class="flex w-full gap-2 md:block">
                             <div class="relative w-full md:flex-1">
                                 ...
                                 <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="input-field pl-10 w-full" placeholder="<?php echo e(__('ui.search_user_placeholder')); ?>" onchange="this.form.submit()">
                             </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['name' => 'role','options' => $roleOptions,'selected' => request('role'),'placeholder' => ''.e(__('ui.all_roles')).'','submitOnChange' => true,'width' => 'w-full md:w-auto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'role','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($roleOptions),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request('role')),'placeholder' => ''.e(__('ui.all_roles')).'','submitOnChange' => true,'width' => 'w-full md:w-auto']); ?>
...
<?php endif; ?>
                             ...
                             <div class="w-full md:w-auto min-w-[150px]">
                                 ...
                                 <?php if (isset($component)) { $__componentOriginaled2cde6083938c436304f332ba96bb7c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled2cde6083938c436304f332ba96bb7c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['name' => 'status','options' => $statusOptions,'selected' => request('status'),'placeholder' => ''.e(__('ui.all_statuses')).'','submitOnChange' => true,'width' => 'w-full md:w-auto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'status','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($statusOptions),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request('status')),'placeholder' => ''.e(__('ui.all_statuses')).'','submitOnChange' => true,'width' => 'w-full md:w-auto']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaled2cde6083938c436304f332ba96bb7c)): ?>
<?php $attributes = $__attributesOriginaled2cde6083938c436304f332ba96bb7c; ?>
...
<?php endif; ?>
                             ...
                             <a href="<?php echo e(route('users.index')); ?>" id="reset-filters" class="btn btn-secondary flex items-center justify-center gap-2 w-full md:w-auto" title="<?php echo e(__('ui.reset_filter')); ?>">
                    ...
                    <div class="card p-4">
                        ...
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <?php if(request('trash')): ?>
                                <div class="flex items-center self-center mr-2">
                                    <input type="checkbox" name="ids[]" value="<?php echo e($user->id); ?>" class="user-checkbox rounded border-secondary-300 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 w-5 h-5">
                                </div>
                            <?php endif; ?>
                            <div class="h-14 w-14 rounded-full bg-secondary-100 flex items-center justify-center text-secondary-500 flex-shrink-0 border border-secondary-200 overflow-hidden">
                                <?php if($user->avatar): ?>
                                    <img src="<?php echo e(asset('storage/' . $user->avatar)); ?>" alt="<?php echo e($user->name); ?>" loading="lazy" class="h-full w-full object-cover">
                                <?php else: ?>
                                    <span class="font-bold text-lg"><?php echo e(substr($user->name, 0, 1)); ?></span>
                                <?php endif; ?>
                            </div>
                                ...
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2 mt-1">
                                            ...
                                            ?>
                                            <span class="inline-flex px-2 py-0.5 rounded text-xs font-medium border <?php echo e($roleColor); ?>">
                                                <?php echo e($user->role->label()); ?>

                                            </span>
                                            <span class="w-1 h-1 rounded-full bg-secondary-300"></span>
                                            <span class="text-xs text-secondary-500"><?php echo e($user->created_at->format('M Y')); ?></span>
                                        </div>
                                    </div>
                        ...
                        <div class="grid grid-cols-1 gap-y-2 text-sm mb-4 border-t border-b border-secondary-100 py-3">
                            ...
                            <div class="flex items-center gap-2 text-secondary-600">
                                ...
                                <span class="truncate"><?php echo e($user->job_title ?? '-'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-2">
                            <?php if(request('trash')): ?>
                                ...
                                <form action="<?php echo e(route('users.restore', $user->id)); ?>" method="POST" class="w-full">
                                    <?php echo csrf_field(); ?>
                            ...
                            <?php else: ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $user)): ?>
                                    <a href="<?php echo e(route('users.edit', $user)); ?>" class="btn btn-sm btn-secondary flex-1 justify-center flex items-center gap-2">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $user)): ?>
                                    <form action="<?php echo e(route('users.destroy', $user)); ?>" method="POST" class="flex-1">
                                        <?php echo csrf_field(); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="card p-8 flex flex-col items-center justify-center text-center">
                        ...
                        <p class="text-secondary-500 text-sm mt-1 max-w-xs mx-auto">
                            ...
                            <?php else: ?>
                                <?php echo e(__('ui.users_empty_desc')); ?>
                    ...
                    <table class="table-modern w-full">
                        <thead>
                            <tr>
                                ...
                                <?php endif; ?>
                                <th><?php echo e(__('ui.profile')); ?></th>
                                <th><?php echo e(__('ui.email_contact')); ?></th>
                                <th><?php echo e(__('ui.job_title')); ?></th>
                                <th><?php echo e(__('ui.role')); ?></th>
                                <th><?php echo e(__('ui.status')); ?></th>
                                <th class="text-right"><?php echo e(__('ui.actions')); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php if (isset($component)) { $__componentOriginal56159727267da4fe64f09437375618d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal56159727267da4fe64f09437375618d6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user.table-row','data' => ['user' => $user,'trash' => request('trash')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('user.table-row'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user),'trash' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request('trash'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal56159727267da4fe64f09437375618d6)): ?>
<?php $attributes = $__attributesOriginal56159727267da4fe64f09437375618d6; ?>
<?php unset($__attributesOriginal56159727267da4fe64f09437375618d6); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal56159727267da4fe64f09437375618d6)): ?>
<?php $component = $__componentOriginal56159727267da4fe64f09437375618d6; ?>
<?php unset($__componentOriginal56159727267da4fe64f09437375618d6); ?>
<?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="<?php echo e(request('trash') ? '7' : '6'); ?>" class="px-6 py-12 text-center text-secondary-500">
    ...
    <?php if(request('trash')): ?>
        <div id="bulk-action-bar" class="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-white rounded-xl shadow-xl border border-secondary-200 px-6 py-3 flex items-center gap-6 z-50 transition-all duration-300 translate-y-24 opacity-0">
            ...
            <div class="flex items-center gap-3">
                <form action="<?php echo e(route('users.bulk-restore')); ?>" method="POST" id="bulk-restore-form">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('users.bulk-force-delete')); ?>" method="POST" id="bulk-delete-form">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.submitBulkRestore = function() {
                ...
                Swal.fire({
                    title: '<?php echo e(__('ui.restore_user_title')); ?>',
                    text: `${selected.length} <?php echo e(__('ui.restore_user_confirm')); ?>`,
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: '<?php echo e(__('ui.yes_restore')); ?>',
            ...
            window.submitBulkDelete = function() {
                ...
                Swal.fire({
                    title: '<?php echo e(__('ui.delete_user_title')); ?>',
                    text: "<?php echo e(__('ui.delete_permanent_confirm')); ?>",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonText: '<?php echo e(__('ui.yes_delete')); ?>',
                    cancelButtonText: '<?php echo e(__('ui.cancel')); ?>',
                    reverseButtons: true,
                    customClass: {
                        popup: '!rounded-2xl !font-sans',
            ...
            window.confirmUserRestore = function(event) {
                ...
                Swal.fire({
                    title: '<?php echo e(__('ui.restore_user_title')); ?>',
                    text: "<?php echo e(__('ui.restore_user_confirm')); ?>",
                    icon: 'question',
                    showCancelButton: true,
                    confirmButtonText: '<?php echo e(__('ui.yes_restore')); ?>',
                    cancelButtonText: '<?php echo e(__('ui.cancel')); ?>',
            ...
            const filterForm = document.querySelector('form[action="<?php echo e(route('users.index')); ?>"]');
...
<?php endif; ?>
<?php /**PATH E:\KULI AH\Semester\Semester 8\Tugas Akhir\Web 2\AzventoryWeb\resources\views/users/index.blade.php ENDPATH**/ ?>