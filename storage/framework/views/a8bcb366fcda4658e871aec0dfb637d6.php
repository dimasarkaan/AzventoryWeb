...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon.tag','data' => ['class' => 'w-6 h-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <div x-show="!isLoadingBrands" class="relative">
                    <div class="grid gap-3">
                        <template x-for="brand in brandsList" :key="brand.id">
                            <div class="bg-white p-4 rounded-2xl border border-secondary-100 shadow-sm hover:shadow-md transition-all group flex items-center justify-between gap-4"
                                 :class="{'ring-2 ring-pink-500 border-transparent bg-pink-50/10': brandEditingId === brand.id}">
                                
                                <div class="flex-grow min-w-0">
                                    
                                    <div x-show="brandEditingId !== brand.id">
                                ...
                                <div x-show="brandEditingId !== brand.id" class="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
...
<?php endif; ?>
                                ...
                                <div x-show="brandEditingId === brand.id" x-cloak class="flex items-center gap-2">
...
<?php endif; ?>
                    ...
                    <div x-show="brandsList.length === 0" class="text-center py-12">
                        <div class="w-16 h-16 bg-secondary-100 rounded-full flex items-center justify-center mx-auto mb-4 text-secondary-400">
                            <?php if (isset($component)) { $__componentOriginal25b175be958d107d1be4a494690443f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal25b175be958d107d1be4a494690443f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon.tag','data' => ['class' => 'w-8 h-8']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon.tag'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php /**PATH E:\KULI AH\Semester\Semester 8\Tugas Akhir\Web 2\AzventoryWeb\resources\views/dashboard/_brand_modal.blade.php ENDPATH**/ ?>