<div 
    x-data="{ 
        ...
        search() {
            this.isLoading = true;
            fetch('<?php echo e(route('global-search')); ?>?query=' + encodeURIComponent(this.query))
        ...
        <div x-show="open" 
            ...
            <ul x-show="query.length >= 2 && totalItems > 0" class="max-h-96 scroll-py-3 overflow-y-auto p-3" id="options" role="listbox">
                ...
                <template x-if="results.menus.length > 0">
                    <li class="mb-2">
                        <h2 class="px-2.5 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider bg-gray-50/50 rounded-md mb-1"><?php echo e(__('ui.search_menu')); ?></h2>
                        <ul class="text-sm text-gray-700">
                            <template x-for="(item, index) in results.menus" :key="item.url">
                                <li class="group flex cursor-default select-none items-center rounded-md p-2 hover:bg-primary-50 hover:text-primary-700 transition"
                                    ...
                                    <span class="ml-3 flex-none text-xs font-medium text-gray-400 group-hover:text-primary-400"><?php echo e(__('ui.search_jump_to')); ?></span>
                                </li>
                            </template>
                        </ul>
                    </li>
                ...
                <template x-if="results.spareparts.length > 0">
                    <li class="mb-2">
                         <h2 class="px-2.5 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider bg-gray-50/50 rounded-md mb-1"><?php echo e(__('ui.search_inventory')); ?></h2>
                        <ul class="text-sm text-gray-700">
                 ...
                 <template x-if="results.users.length > 0">
                    <li class="mb-2">
                         <h2 class="px-2.5 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider bg-gray-50/50 rounded-md mb-1"><?php echo e(__('ui.search_users')); ?></h2>
                        <ul class="text-sm text-gray-700">
            ...
            <div x-show="query.length >= 2 && totalItems === 0 && !isLoading" class="px-6 py-14 text-center text-sm sm:px-14">
                ...
                <p class="mt-4 font-semibold text-gray-900"><?php echo e(__('ui.search_no_results')); ?></p>
                <p class="mt-2 text-gray-500"><?php echo e(__('ui.search_no_results_desc')); ?></p>
            </div>
            ...
            <div class="flex flex-wrap items-center bg-gray-50 px-4 py-2.5 text-xs text-gray-500">
               <span class="mx-1 font-medium text-gray-900"><?php echo e(__('ui.search_enter')); ?></span>
               <?php echo e(__('ui.search_select')); ?>

               <span class="mx-1 ml-3 font-medium text-gray-900">↑↓</span>
               <?php echo e(__('ui.search_navigate')); ?>

               <span class="mx-1 ml-3 font-medium text-gray-900"><?php echo e(__('ui.search_esc')); ?></span>
               <?php echo e(__('ui.search_close')); ?>

            </div>
        </div>
    </div>
</div>
<?php /**PATH E:\KULI AH\Semester\Semester 8\Tugas Akhir\Web 2\AzventoryWeb\resources\views/components/spotlight-search.blade.php ENDPATH**/ ?>