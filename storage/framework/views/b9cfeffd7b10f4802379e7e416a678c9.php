            ...
            <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h2 class="text-3xl font-bold text-secondary-900 tracking-tight">
                        <?php echo e(__('ui.my_inventory_title')); ?>

                    </h2>
                    <p class="mt-1 text-sm text-secondary-500">
                        <?php echo e(__('ui.my_inventory_desc')); ?>

                    </p>
                </div>
                <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-secondary w-full sm:w-auto text-center">
                    <?php echo e(__('ui.back_to_profile')); ?>
            ...
            <div>
                ...
                <div class="sm:hidden mb-4">
                    <select x-model="activeTab" class="block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-primary-500 focus:outline-none focus:ring-primary-500 sm:text-sm">
                        <option value="active"><?php echo e(__('ui.tab_active_borrowings')); ?></option>
                        <option value="history"><?php echo e(__('ui.tab_history')); ?></option>
                    </select>
                </div>
                ...
                <div class="hidden sm:block border-b border-gray-200 mb-6">
                    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                        ...
                        >
                            ...
                            <?php echo e(__('ui.tab_active_borrowings')); ?>

                            <?php if($activeBorrowings->count() > 0): ?>
                                <span class="bg-primary-100 text-primary-600 py-0.5 px-2.5 rounded-full text-xs font-semibold"><?php echo e($activeBorrowings->count()); ?></span>
                            <?php endif; ?>
                        </button>
                        <button 
                ...
                <div x-show="activeTab === 'active'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0">
                    <div class="card overflow-hidden">
                        <?php if($activeBorrowings->isEmpty()): ?>
                            <div class="p-12 text-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900"><?php echo e(__('ui.no_active_borrowings')); ?></h3>
                                <p class="text-gray-500 mt-1"><?php echo e(__('ui.no_active_borrowings_desc')); ?></p>
                            </div>
                        <?php else: ?>
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50 hidden sm:table-header-group">
                                        <tr>
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('ui.item')); ?></th>
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('ui.quantity')); ?></th>
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('ui.borrow_date')); ?></th>
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('ui.due_date')); ?></th>
                                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('ui.actions')); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__currentLoopData = $activeBorrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrowing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="flex flex-col sm:table-row hover:bg-gray-50 transition-colors cursor-pointer group relative" onclick="if(!event.target.closest('.no-click')) window.location='<?php echo e(route('inventory.show', $borrowing->sparepart->id)); ?>'">
                                                <td class="px-6 py-4 whitespace-nowrap sm:w-1/3">
                                                    <div class="flex items-center">
                                                        <div class="flex-shrink-0 h-10 w-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-500 overflow-hidden">
                                                            <?php if($borrowing->sparepart->image): ?>
                                                                <img src="<?php echo e(asset('storage/' . $borrowing->sparepart->image)); ?>" alt="" class="h-10 w-10 object-cover">
                                                            <?php elseif($borrowing->sparepart->image_path): ?>
                                                                <img src="<?php echo e(asset('storage/' . $borrowing->sparepart->image_path)); ?>" alt="" class="h-10 w-10 object-cover">
                                                            <?php else: ?>
                                                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div class="ml-4">
                                                            <div class="text-sm font-medium text-gray-900 group-hover:text-primary-600 transition-colors"><?php echo e($borrowing->sparepart->name); ?></div>
                                                            <div class="text-xs text-gray-500"><?php echo e($borrowing->sparepart->part_number); ?></div>
                                                            <!-- Mobile only meta -->
                                                            <div class="sm:hidden mt-2 flex items-center gap-2 text-xs text-gray-500">
                                                                <span><?php echo e($borrowing->quantity); ?> <?php echo e($borrowing->sparepart->unit); ?></span>
                                                                <span>&bull;</span>
                                                                <?php if($borrowing->expected_return_at->isPast()): ?>
                                                                    <span class="text-danger-600 font-bold"><?php echo e($borrowing->expected_return_at->format('d M Y')); ?></span>
                                                                <?php else: ?>
                                                                    <span><?php echo e($borrowing->expected_return_at->format('d M Y')); ?></span>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="hidden sm:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($borrowing->quantity); ?> <?php echo e($borrowing->sparepart->unit); ?></td>
                                                <td class="hidden sm:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($borrowing->borrowed_at->format('d M Y')); ?></td>
                                                <td class="hidden sm:table-cell px-6 py-4 whitespace-nowrap text-sm">
                                                    <?php if($borrowing->expected_return_at->isPast()): ?>
                                                        <span class="text-danger-600 font-bold flex items-center gap-1">
                                                            ...
                                                            <?php echo e($borrowing->expected_return_at->format('d M Y')); ?>

                                                        </span>
                                                    <?php else: ?>
                                                        <span class="text-gray-500"><?php echo e($borrowing->expected_return_at->format('d M Y')); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium sm:w-1/6">
                                                     <div class="flex items-center justify-end gap-2">
                                                        <button 
                                                            ...
                                                            @click.stop="openReturnModal({ id: <?php echo e($borrowing->id); ?>, quantity: <?php echo e($borrowing->quantity); ?> })"
                                                        >
                                                            <?php echo e(__('ui.return_action')); ?>
                ...
                <div x-show="activeTab === 'history'" style="display: none;" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0">
                    <div class="card overflow-hidden">
                        <?php if($historyBorrowings->isEmpty()): ?>
                            <div class="p-12 text-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900"><?php echo e(__('ui.no_history_borrowings')); ?></h3>
                                <p class="text-gray-500 mt-1"><?php echo e(__('ui.no_history_borrowings_desc')); ?></p>
                            </div>
                        <?php else: ?>
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50 hidden sm:table-header-group">
                                        <tr>
                                            ...
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('ui.quantity')); ?></th>
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('ui.borrow_date')); ?></th>
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('ui.return_date')); ?></th>
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('ui.status')); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__currentLoopData = $historyBorrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrowing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="flex flex-col sm:table-row hover:bg-gray-50 transition-colors cursor-pointer" onclick="window.location='<?php echo e(route('inventory.show', $borrowing->sparepart->id)); ?>'">
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="ml-4">
                                                            <div class="text-sm font-medium text-gray-900"><?php echo e($borrowing->sparepart->name); ?></div>
                                                            <div class="text-xs text-gray-500"><?php echo e($borrowing->sparepart->part_number); ?></div>
                                                             <!-- Mobile only meta -->
                                                             <div class="sm:hidden mt-2 flex items-center gap-2 text-xs text-gray-500">
                                                                <span><?php echo e($borrowing->returned_at->format('d M Y')); ?></span>
                                                                <span>&bull;</span>
                                                                <span class="text-success-600 font-medium"><?php echo e(__('ui.status_returned_badge')); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="hidden sm:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($borrowing->quantity); ?> <?php echo e($borrowing->sparepart->unit); ?></td>
                                                <td class="hidden sm:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($borrowing->borrowed_at->format('d M Y')); ?></td>
                                                <td class="hidden sm:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($borrowing->returned_at->format('d M Y')); ?></td>
                                                <td class="hidden sm:table-cell px-6 py-4 whitespace-nowrap">
                                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-success-100 text-success-800">
                                                        <?php echo e(__('ui.status_returned_badge')); ?>
                                ...
                                <form :action="`/my-inventory/return/${selectedBorrowingId}`" method="POST" enctype="multipart/form-data" class="flex flex-col flex-1 min-h-0"
                                    ...
                                    <div class="flex-1 overflow-y-auto px-4 pt-2 pb-4 sm:px-6 space-y-4 custom-scrollbar">
                                        ...
                                        <div class="mt-4" x-show="returnCondition !== 'lost'" x-data="{ 
                                            ...
                                            async startCamera() {
                                                ...
                                                this.$nextTick(async () => {
                                                    try {
                                                        ...
                                                        let msg = "<?php echo e(__('ui.camera_error_default')); ?>";
                                                        const errStr = err.toString();
                                                        if (errStr.includes('NotAllowedError') || errStr.includes('PermissionDeniedError')) msg = "<?php echo e(__('ui.camera_error_not_allowed')); ?>";
                                                        else if (errStr.includes('NotFoundError')) msg = "<?php echo e(__('ui.camera_error_not_found')); ?>";
                                                        else if (errStr.includes('NotReadableError')) msg = "<?php echo e(__('ui.camera_error_not_readable')); ?>";
                                            ...
                                            <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('ui.upload_photo')); ?> <span class="text-danger-500">*</span></label>
                                        ...
                                        <!-- Notes -->
                                        <div>
                                            <label for="return_notes" class="block text-sm font-medium text-gray-700"><?php echo e(__('ui.notes')); ?> <span class="text-secondary-400 font-normal">(Opsional)</span></label>
...
<?php endif; ?>
<?php /**PATH E:\KULI AH\Semester\Semester 8\Tugas Akhir\Web 2\AzventoryWeb\resources\views/profile/my_inventory.blade.php ENDPATH**/ ?>