...
<?php $component->withAttributes([]); ?>
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 class="text-3xl font-bold text-secondary-900 tracking-tight">
                        <?php echo e(__('ui.scan_qr_title')); ?>

                    </h2>
                    <p class="mt-1 text-sm text-secondary-500"><?php echo e(__('ui.scan_qr_desc')); ?></p>
                </div>
                <div>
                     <a href="<?php echo e(route('inventory.index')); ?>" class="btn btn-secondary flex items-center gap-2">
                        ...
                        <?php echo e(__('ui.back_to_inventory')); ?>
                ...
                <div class="lg:col-span-8">
                    <div class="card bg-white shadow-xl rounded-2xl overflow-hidden border border-secondary-200 relative group">
                        ...
                        <div class="p-3 border-b border-secondary-100 flex justify-between items-center bg-secondary-50">
                            ...
                            <div class="flex items-center gap-2">
                                <span class="text-[10px] font-mono text-secondary-500 uppercase tracking-wider"><?php echo e(__('ui.camera_feed_live')); ?></span>
                        ...
                        <div class="relative bg-black aspect-video w-full overflow-hidden">
                            ...
                            <div id="camera-placeholder" class="absolute inset-0 flex flex-col items-center justify-center bg-secondary-900 z-10 p-6 text-center">
                                ...
                                <h3 class="text-white font-medium text-base"><?php echo e(__('ui.camera_inactive')); ?></h3>
                                <p class="text-secondary-400 text-xs mt-1 max-w-xs"><?php echo e(__('ui.camera_permission_desc')); ?></p>
                    ...
                    <div id="result" class="mt-4 hidden transform transition-all duration-500 ease-out">
                        <div class="bg-white p-4 rounded-xl border border-success-200 shadow-lg flex items-center gap-4">
                            ...
                            <div>
                                <h4 class="text-base font-bold text-gray-900"><?php echo e(__('ui.qr_found')); ?></h4>
                                <p class="text-xs text-gray-500"><?php echo e(__('ui.redirecting_to_inventory')); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="error-message" class="mt-4 hidden transform transition-all duration-300">
                        <div class="bg-white p-3 rounded-xl border-l-4 border-danger-500 shadow-md flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-xs"><?php echo e(__('ui.scan_failed')); ?></h4>
                ...
                <div class="lg:col-span-4 space-y-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="relative py-1">
                                ...
                                <div class="relative flex justify-center">
                                    <span class="px-2 bg-white text-[10px] text-gray-400 font-medium"><?php echo e(__('ui.or')); ?></span>
                                </div>
                            </div>
                             ...
                             <label for="qr-input-file" class="w-full btn btn-secondary justify-center cursor-pointer py-2 bg-gray-50 hover:bg-gray-100 border-dashed border-2 border-gray-300 text-sm">
                                ...
                                <span class="text-gray-600"><?php echo e(__('ui.upload_image')); ?></span>
                    ...
                    <div class="bg-blue-50 rounded-xl p-4 border border-blue-100">
                        <h4 class="text-blue-800 font-semibold mb-2 text-xs flex items-center gap-2">
                            ...
                            <?php echo e(__('ui.guide')); ?>

                        </h4>
                        <ul class="text-xs text-blue-700 space-y-1.5 list-disc pl-4">
                            <li><?php echo e(__('ui.guide_1')); ?></li>
                            <li><?php echo e(__('ui.guide_2')); ?></li>
                            <li><?php echo e(__('ui.guide_3')); ?></li>
                        </ul>
                    </div>
                </div>
    ...
    <script>
        ...
        const updateButtonState = (isRunning) => {
            ...
            if (isRunning) {
                btnCameraText.innerText = "<?php echo e(__('ui.stop_camera')); ?>";
                btn.classList.replace('btn-outline-primary', 'btn-outline-danger');
            } else {
                btnCameraText.innerText = "<?php echo e(__('ui.start_camera')); ?>";
                ...
                if (file.type === 'image/svg+xml') {
                    convertSvgToPng(file).then(pngFile => {
                        scanFile(pngFile);
                         ...
                         document.getElementById('error-text').innerText = "<?php echo e(__('ui.error_process_svg')); ?>";
                         errorDiv.classList.remove('hidden');
                    });
                } else {
                    scanFile(file);
        ...
        const scanFile = (file) => {
             html5QrCode.scanFile(file, true)
                ...
                .catch(err => {
                    const errorDiv = document.getElementById('error-message');
                    document.getElementById('error-text').innerText = "<?php echo e(__('ui.error_scan_image')); ?>";
                    errorDiv.classList.remove('hidden');
                    console.error(err);
                });
        }
...
<?php endif; ?>
<?php /**PATH E:\KULI AH\Semester\Semester 8\Tugas Akhir\Web 2\AzventoryWeb\resources\views/inventory/scan-qr.blade.php ENDPATH**/ ?>