                ...
                <div class="card flex flex-col lg:col-span-2">
                    <div class="card-header border-b border-secondary-100 p-4 sm:p-5 flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div x-data="{ open: false }" class="relative z-20">
                            <form method="GET" action="<?php echo e(route('dashboard.operator')); ?>" x-ref="trendForm">
                        ...
                        <template x-if="activeBorrowingsList.length > 0">
                            <div class="contents">
                                    ...
                                    <table class="table-modern w-full">
                                        ...
                                        <tbody class="divide-y divide-secondary-100">
                                            <template x-for="borrowing in activeBorrowingsList" :key="borrowing.id">
                                                <tr class="hover:bg-secondary-50/50 transition-colors cursor-pointer" @click="window.location.href='<?php echo e(route('inventory.index')); ?>/' + borrowing.sparepart_id">
                                                    <td>
                                ...
                                <div class="md:hidden divide-y divide-secondary-100">
                                    <template x-for="borrowing in activeBorrowingsList" :key="borrowing.id">
                                        <div class="p-4 bg-white hover:bg-secondary-50 transition-colors cursor-pointer" @click="window.location.href='<?php echo e(route('inventory.index')); ?>/' + borrowing.sparepart_id">
                    ...
                    <div class="card-body flex-1 p-0 overflow-y-auto max-h-[350px] custom-scrollbar">
                        ...
                        <template x-if="pendingRequestsList.length > 0">
                            <div class="contents">
                                    ...
                                    <table class="table-modern w-full">
                                        ...
                                        <tbody class="divide-y divide-secondary-100">
                                            <template x-for="request in pendingRequestsList" :key="request.id">
                                                <tr class="hover:bg-secondary-50/50 transition-colors cursor-pointer" @click="window.location.href='<?php echo e(route('inventory.index')); ?>/' + request.sparepart_id">
                                                    <td>
                                ...
                                <div class="md:hidden divide-y divide-secondary-100">
                                    <template x-for="request in pendingRequestsList" :key="request.id">
                                        <div class="p-4 bg-white hover:bg-secondary-50 transition-colors cursor-pointer" @click="window.location.href='<?php echo e(route('inventory.index')); ?>/' + request.sparepart_id">
                                            <div class="flex justify-between items-start mb-2">
                                    ...
                                    <div class="relative group p-3 border border-secondary-200 rounded-xl hover:shadow-sm hover:border-primary-300 transition-all duration-300 bg-white">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <h4 class="font-bold text-sm text-secondary-900 line-clamp-1 cursor-pointer hover:text-primary-600 transition-colors" @click="window.location.href='<?php echo e(route('inventory.index')); ?>/' + pick.sparepart_id" x-text="pick.sparepart_name"></h4>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon.scan-qr','data' => ['class' => 'w-6 h-6 sm:w-7 sm:h-7 group-hover:rotate-12 transition-transform duration-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 sm:w-7 sm:h-7 group-hover:rotate-12 transition-transform duration-300']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <script>
        function operatorDashboardData() {
            return {
                ...
                pendingRequestsList: <?php echo json_encode($pendingRequestsList ?? [], 15, 512) ?>,
                topPicks: <?php echo json_encode($topPicks ?? [], 15, 512) ?>,
                activityLogs: <?php echo json_encode($activityLogs ?? [], 15, 512) ?>
            }
        }
    </script>
            ...
            const onScanSuccess = (decodedText, decodedResult) => {
                ...
                const processResult = () => {
                    ...
                    if (decodedText.startsWith('http')) {
                        ...
                        window.location.href = `<?php echo e(route('inventory.index')); ?>?search=${encodeURIComponent(decodedText)}`;
                    }
                };
