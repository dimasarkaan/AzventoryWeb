        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
            ...
            <div x-show="showStats && !isLoading"
                ...
                <div class="card p-6 flex items-center justify-between bg-white border-none shadow-xl shadow-secondary-900/10 rounded-2xl relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="pl-4">
                        <p class="text-[11px] font-extrabold text-primary-500 mb-1 uppercase tracking-[0.15em]"><?php echo e(__('ui.total_items')); ?></p>
                        <h3 class="text-4xl font-black text-secondary-900 leading-none" x-text="totalSpareparts"><?php echo e($totalSpareparts); ?></h3>
                        <p class="text-[10px] font-bold text-secondary-400 mt-2 uppercase tracking-wider"><?php echo e(__('ui.sku_items')); ?></p>
                    </div>
                    <div class="relative">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon.inventory','data' => ['class' => 'w-10 h-10']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="card p-6 flex items-center justify-between bg-white border-none shadow-xl shadow-secondary-900/10 rounded-2xl relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="pl-4">
                        <p class="text-[11px] font-extrabold text-success-500 mb-1 uppercase tracking-[0.15em]"><?php echo e(__('ui.total_physical_stock')); ?></p>
                        <h3 class="text-4xl font-black text-secondary-900 leading-none" x-text="totalStock"><?php echo e($totalStock); ?></h3>
                        <p class="text-[10px] font-bold text-secondary-400 mt-2 uppercase tracking-wider"><?php echo e(__('ui.units')); ?></p>
                    </div>
                    <div class="relative">
                        ...
                        <div class="relative p-4 bg-success-50 text-success-600 rounded-3xl group-hover:scale-110 transition-transform">
                            <?php if (isset($component)) { $__componentOriginal9021a7c39fc1f9da1eab8489680add27 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9021a7c39fc1f9da1eab8489680add27 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon.package','data' => ['class' => 'w-10 h-10']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon.package'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9021a7c39fc1f9da1eab8489680add27)): ?>
<?php $attributes = $__attributesOriginal9021a7c39fc1f9da1eab8489680add27; ?>
<?php unset($__attributesOriginal9021a7c39fc1f9da1eab8489680add27); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal9021a7c39fc1f9da1eab8489680add27)): ?>
<?php $component = $__componentOriginal9021a7c39fc1f9da1eab8489680add27; ?>
<?php unset($__componentOriginal9021a7c39fc1f9da1eab8489680add27); ?>
<?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="card p-6 flex items-center justify-between bg-white border-none shadow-xl shadow-secondary-900/10 rounded-2xl relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="pl-4">
                        <p class="text-[11px] font-extrabold text-warning-500 mb-1 uppercase tracking-[0.15em]"><?php echo e(__('ui.categories')); ?></p>
                        <h3 class="text-4xl font-black text-secondary-900 leading-none"><?php echo e($totalCategories); ?></h3>
                        <p class="text-[10px] font-bold text-secondary-400 mt-2 uppercase tracking-wider"><?php echo e(__('ui.item_types')); ?></p>
                    </div>
                    <div class="relative">
                        ...
                        <div class="relative p-4 bg-warning-50 text-warning-600 rounded-3xl group-hover:scale-110 transition-transform">
                            <?php if (isset($component)) { $__componentOriginal71d34cd6b5098862348da0456bab239d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal71d34cd6b5098862348da0456bab239d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon.category','data' => ['class' => 'w-10 h-10']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon.category'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal71d34cd6b5098862348da0456bab239d)): ?>
<?php $attributes = $__attributesOriginal71d34cd6b5098862348da0456bab239d; ?>
<?php unset($__attributesOriginal71d34cd6b5098862348da0456bab239d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71d34cd6b5098862348da0456bab239d)): ?>
<?php $component = $__componentOriginal71d34cd6b5098862348da0456bab239d; ?>
<?php unset($__componentOriginal71d34cd6b5098862348da0456bab239d); ?>
<?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div x-show="showBorrowings" class="card p-6 flex items-center justify-between bg-white border-none shadow-xl shadow-secondary-900/10 rounded-2xl relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="pl-4">
                        <p class="text-[11px] font-extrabold text-indigo-500 mb-1 uppercase tracking-[0.15em]"><?php echo e(__('ui.currently_borrowed')); ?></p>
                        <h3 class="text-4xl font-black text-secondary-900 leading-none"><?php echo e($activeBorrowingsCount); ?></h3>
                        <p class="text-[10px] font-bold text-secondary-400 mt-2 uppercase tracking-wider"><?php echo e(__('ui.units_out')); ?></p>
                    </div>
                    <div class="relative">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon.borrow-user','data' => ['class' => 'w-10 h-10']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="card p-6 flex items-center justify-between bg-white border-none shadow-xl shadow-secondary-900/10 rounded-2xl relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="pl-4">
                        <p class="text-[11px] font-extrabold text-secondary-600 mb-1 uppercase tracking-[0.15em]"><?php echo e(__('ui.storage_locations')); ?></p>
                        <h3 class="text-4xl font-black text-secondary-900 leading-none"><?php echo e($totalLocations); ?></h3>
                        <p class="text-[10px] font-bold text-secondary-400 mt-2 uppercase tracking-wider"><?php echo e(__('ui.warehouse_racks')); ?></p>
                    </div>
                    <div class="relative">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon.location','data' => ['class' => 'w-10 h-10']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <div class="flex items-center gap-1 bg-secondary-100 rounded-lg p-0.5" id="movement-range-btns">
                            <button onclick="fetchMovementData(7)" id="mov-btn-7"
                                    class="mov-range-btn px-2.5 py-1 rounded-md text-xs font-medium transition-all
                                           <?php echo e(in_array($activePeriod, ['today', 'this_week']) ? 'bg-white shadow-sm text-primary-700' : 'text-secondary-600 hover:bg-white/70'); ?>">7 Hari</button>
                            <button onclick="fetchMovementData(30)" id="mov-btn-30"
                                    class="mov-range-btn px-2.5 py-1 rounded-md text-xs font-medium transition-all
                                           <?php echo e($activePeriod === 'this_month' ? 'bg-white shadow-sm text-primary-700' : 'text-secondary-600 hover:bg-white/70'); ?>">30 Hari</button>
                            <button onclick="fetchMovementData(90)" id="mov-btn-90"
                                    class="mov-range-btn px-2.5 py-1 rounded-md text-xs font-medium transition-all
                                           <?php echo e(in_array($activePeriod, ['this_year', 'custom', 'custom_year']) ? 'bg-white shadow-sm text-primary-700' : 'text-secondary-600 hover:bg-white/70'); ?>">3 Bulan</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div x-show="showRecent && !isLoading"
                    ...
                    <div class="card-header p-5 border-b border-secondary-100 flex justify-between items-center bg-white">
                        ...
                        <a href="<?php echo e(route('reports.activity-logs.index')); ?>" class="text-xs font-bold text-primary-600 hover:text-primary-700 transition-colors bg-primary-50 px-3 py-1.5 rounded-full border border-primary-100 shadow-sm hover:bg-primary-100"><?php echo e(__('ui.view_all')); ?></a>
                    </div>
    ...
    <script>
        ...
        function globalPeriodFilter() {
            return {
                showCustom: <?php echo e(in_array($period ?? 'this_month', ['custom','custom_year']) ? 'true' : 'false'); ?>,
            };
        }
        ...
        // =====================================================================
        let movementActiveRange = <?php echo e(($activePeriod ?? 'this_month') === 'this_month' ? '30' : '7'); ?>;
