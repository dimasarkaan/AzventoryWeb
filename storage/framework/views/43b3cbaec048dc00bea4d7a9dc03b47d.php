...
<?php $component->withAttributes([]); ?>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                <div>
                    <div class="flex items-center gap-3">
                        ...
                        <?php if($sparepart->status === 'aktif'): ?>
                            <span class="badge badge-success"><?php echo e(__('ui.status_active')); ?></span>
                        <?php else: ?>
                            <span class="badge badge-danger"><?php echo e(__('ui.status_inactive')); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="flex items-center gap-2 mt-1.5 text-secondary-500 font-mono text-sm">
                        ...
                        <?php echo e($sparepart->part_number); ?>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="<?php echo e(route('inventory.edit', $sparepart)); ?>" class="btn btn-warning">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 flex flex-col gap-6">
                    ...
                    <div class="card overflow-hidden">
                        <div class="aspect-video w-full bg-secondary-100 flex items-center justify-center relative">
                            <?php if($sparepart->image): ?>
                                <img src="<?php echo e(asset('storage/' . $sparepart->image)); ?>" alt="<?php echo e($sparepart->name); ?>" loading="lazy" class="w-full h-full object-cover">
                            <?php else: ?>
                                <div class="text-secondary-400 flex flex-col items-center">
                                    ...
                                    <span class="text-sm"><?php echo e(__('ui.no_image')); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="card p-6 flex-1 flex flex-col">
                        <h3 class="text-lg font-bold text-secondary-900 mb-4 border-b border-secondary-100 pb-2"><?php echo e(__('ui.detail_info')); ?></h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <span class="text-xs text-secondary-400 uppercase tracking-wider font-semibold"><?php echo e(__('ui.category')); ?></span>
                            ...
                            <div>
                                <span class="text-xs text-secondary-400 uppercase tracking-wider font-semibold"><?php echo e(__('ui.brand')); ?></span>
                            ...
                            <div>
                                <span class="text-xs text-secondary-400 uppercase tracking-wider font-semibold"><?php echo e(__('ui.color')); ?></span>
                                <div class="mt-1 text-secondary-900 font-medium">
                                    <?php echo e($sparepart->color ?? '-'); ?>

                                </div>
                            </div>
                            <div>
                                <span class="text-xs text-secondary-400 uppercase tracking-wider font-semibold"><?php echo e(__('ui.storage_location')); ?></span>
                                <div class="mt-1 text-secondary-900 font-medium flex items-center gap-2">
                                     <span class="p-1.5 bg-warning-50 text-warning-600 rounded-md">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                    </span>
                                    <?php echo e($sparepart->location); ?>

                                </div>
                            </div>
                            <div>
                                <span class="text-xs text-secondary-400 uppercase tracking-wider font-semibold"><?php echo e(__('ui.age')); ?></span>
                                <div class="mt-1 text-secondary-900 font-medium">
                                    <?php echo e($sparepart->age ?? '-'); ?>

                                </div>
                            </div>
                            <div>
                                <span class="text-xs text-secondary-400 uppercase tracking-wider font-semibold"><?php echo e(__('ui.condition')); ?></span>
                                <div class="mt-1 text-secondary-900 font-medium">
                                    <?php echo e($sparepart->condition); ?>

                                </div>
                            </div>
                            <?php if($sparepart->type === 'sale'): ?>
                            <div>
                ...
                <div class="flex flex-col gap-6">
                                ...
                                <?php if($sparepart->type === 'asset'): ?>
                                    ...
                                    <?php else: ?>
                                        <div class="bg-warning-50 text-warning-700 p-3 rounded-lg text-sm flex items-start gap-2 border border-warning-200">
                                            ...
                                            <div>
                                                <span class="font-bold block"><?php echo e(__('ui.cannot_borrow')); ?></span>
                                                <?php echo e(__('ui.cannot_borrow_desc', ['condition' => $sparepart->condition])); ?>
                            ...
                            <div x-show="stockModalOpen" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                    ...
                                    <div x-show="stockModalOpen" 
                                        ...
                                        <form action="<?php echo e(route('inventory.stock.request.store', $sparepart)); ?>" method="POST" novalidate>
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                <div class="space-y-4">
                                                                ...
                                                                <div class="mt-2 grid grid-cols-2 gap-3">
                                                                    <label class="relative flex cursor-pointer rounded-lg border bg-white p-3 shadow-sm focus:outline-none hover:bg-gray-50 transition-colors">
                                                                        ...
                                                                        <div class="w-full text-center peer-checked:text-primary-600 font-medium text-gray-500">
                                                                            <span class="block text-sm"><?php echo e(__('ui.stock_in')); ?></span>
                                                                        </div>
                                                                    ...
                                                                    <label class="relative flex cursor-pointer rounded-lg border bg-white p-3 shadow-sm focus:outline-none hover:bg-gray-50 transition-colors">
                                                                        <input type="radio" name="type" value="keluar" x-model="type" class="peer sr-only">
                                                                         <div class="w-full text-center peer-checked:text-danger-600 font-medium text-gray-500">
                                                                            <span class="block text-sm"><?php echo e(__('ui.stock_out')); ?></span>
                                                                        </div>
                                                            ...
                                                            <div>
                                                                <label for="quantity" class="block text-sm font-medium text-gray-700"><?php echo e(__('ui.quantity')); ?> <span class="text-danger-500">*</span></label>
                                                            ...
                                                            <div>
                                                                <label for="reason" class="block text-sm font-medium text-gray-700"><?php echo e(__('ui.reason')); ?> <span class="text-danger-500">*</span></label>
                                                                <div class="mt-1">
                            ...
                            <div x-show="borrowModalOpen" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                    ...
                                    <div x-show="borrowModalOpen" 
                                         ...
                                         x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
                                        <form action="<?php echo e(route('inventory.borrow.store', $sparepart)); ?>" method="POST" novalidate>
                                            <?php echo csrf_field(); ?>
                                            <div class="bg-white px-4 py-4 sm:px-6 border-b border-gray-200 flex-none z-10 shadow-sm">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-full bg-primary-100 mx-0">
                                            ...
                                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                <div class="space-y-4">
                                                            ...
                                                            <div>
                                                                <label for="borrow_quantity" class="block text-sm font-medium text-gray-700"><?php echo e(__('ui.quantity')); ?> <span class="text-danger-500">*</span></label>
                                                            ...
                                                            <div>
                                                                <label for="expected_return_at" class="block text-sm font-medium text-gray-700"><?php echo e(__('ui.expected_return_date')); ?> <span class="text-danger-500">*</span></label>
                                                                <input type="date" name="expected_return_at" id="expected_return_at" x-model="dueDate" min="<?php echo e(date('Y-m-d')); ?>" class="form-input mt-1 block w-full rounded-md border-gray-300 focus:border-primary-500 focus:ring-primary-500 sm:text-sm" required>
                                                            </div>

                                                            <div>
                                                                <label for="notes" class="block text-sm font-medium text-gray-700"><?php echo e(__('ui.notes')); ?> <span class="text-secondary-400 font-normal">(Opsional)</span></label>
                                            ...
                                            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                                <button type="submit" 
                                                        ...
                                                        :class="{ 'opacity-50 cursor-not-allowed bg-gray-400 hover:bg-gray-400': !isValid, 'bg-primary-600 hover:bg-primary-700': isValid }"
                                                        class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 sm:ml-3 sm:w-auto sm:text-sm transition-all">
                                                    <?php echo e(__('ui.confirm_borrow')); ?>
                    ...
                    <div class="card p-6 flex-1 flex flex-col h-full"> 
                        <h3 class="text-sm font-bold text-secondary-900 mb-4 uppercase tracking-wider flex-none"><?php echo e(__('ui.qr_identification')); ?></h3>
                        
                        <div class="flex-1 flex flex-col items-center justify-center min-h-[200px]"> <!-- Centered Content area -->
                            <?php if($sparepart->qr_code_path): ?>
                                <div class="bg-white p-2 rounded-xl shadow-sm border border-secondary-100 mb-6">
                                     <img src="<?php echo e(asset('storage/' . $sparepart->qr_code_path)); ?>" alt="QR Code" class="w-56 h-56">
                                </div>
                                <div class="grid grid-cols-2 gap-3 w-full max-w-xs">
                                    <a href="<?php echo e(route('inventory.qr.download', $sparepart)); ?>" class="btn btn-secondary justify-center text-sm py-2">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>
                                        <?php echo e(__('ui.download')); ?>

                                    </a>
                                     <a href="<?php echo e(route('inventory.qr.print', $sparepart)); ?>" target="_blank" class="btn btn-secondary justify-center text-sm py-2">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" /></svg>
                                        <?php echo e(__('ui.print')); ?>

                                    </a>
                                </div>
                            <?php else: ?>
                                <div class="bg-secondary-50 w-full h-40 rounded-xl flex items-center justify-center text-secondary-400 mb-4">
                                    <span class="text-sm italic"><?php echo e(__('ui.no_qr')); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>

                        <div class="mt-auto pt-6 border-t border-gray-100 text-xs text-secondary-400 space-y-1 text-center flex-none">
                            <p><?php echo e(__('ui.created_at')); ?>: <?php echo e($sparepart->created_at->isoFormat('D MMMM Y HH:mm')); ?></p>
                            <p><?php echo e(__('ui.updated_at')); ?>: <?php echo e($sparepart->updated_at->isoFormat('D MMMM Y HH:mm')); ?></p>
                        </div>
                    </div>
                ...
                <div class="col-span-1 lg:col-span-3">
                        ...
                        <!-- History Card -->
                        <div class="card p-6">
                            <h3 class="text-lg font-bold text-secondary-900 mb-4 border-b border-secondary-100 pb-2"><?php echo e(__('ui.borrowing_history')); ?></h3>
                            ...
                            <div class="hidden md:block overflow-x-auto">
                                <table class="w-full text-sm text-left">
                                    <thead class="text-xs text-secondary-500 uppercase bg-secondary-50">
                                        <tr>
                                            <th class="px-4 py-3 whitespace-nowrap"><?php echo e(__('ui.borrower')); ?></th>
                                            <th class="px-4 py-3 whitespace-nowrap"><?php echo e(__('ui.quantity')); ?></th>
                                            <th class="px-4 py-3 whitespace-nowrap"><?php echo e(__('ui.borrow_date')); ?></th>
                                            <th class="px-4 py-3 whitespace-nowrap"><?php echo e(__('ui.expected_return_date')); ?></th>
                                            <th class="px-4 py-3 whitespace-nowrap"><?php echo e(__('ui.status')); ?></th>
                                            <th class="px-4 py-3 whitespace-nowrap text-right"><?php echo e(__('ui.actions')); ?></th>
                                        </tr>
                                    </thead>
                                    ...
                                    <?php $__currentLoopData = $borrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrowing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($canView): ?>
                                        <tr class="hover:bg-primary-50 transition-colors group cursor-pointer" onclick="window.location.href='<?php echo e(route('inventory.borrow.show', $borrowing)); ?>'">
                                            <td class="px-4 py-3 text-secondary-900 font-medium">
                                                <div class="flex items-center gap-3">
                                                    <div class="w-8 h-8 rounded-full bg-secondary-200 overflow-hidden flex-shrink-0">
                                                        <?php if($borrowing->user && $borrowing->user->avatar): ?>
                                                            <img src="<?php echo e(asset('storage/' . $borrowing->user->avatar)); ?>" class="w-full h-full object-cover">
                                                        <?php else: ?>
                                                            <div class="w-full h-full flex items-center justify-center text-secondary-500 text-xs font-bold">
                                                                <?php echo e(substr($borrowing->user->name ?? 'U', 0, 1)); ?>

                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="flex flex-col">
                                                        <span><?php echo e($borrowing->user->name ?? 'User Terhapus'); ?></span>
                                                        <span class="text-xs text-secondary-500"><?php echo e($borrowing->user->role ?? '-'); ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-4 py-3 text-secondary-600">
                                                <span class="font-bold text-secondary-900 bg-secondary-100 px-2 py-1 rounded-lg text-xs">
                                                    <?php echo e($borrowing->quantity); ?> <?php echo e($sparepart->unit); ?>

                                                    <?php if($borrowing->remaining_quantity < $borrowing->quantity): ?>
                                                        <span class="text-xs text-secondary-500 font-normal block mt-1">Sisa: <?php echo e($borrowing->remaining_quantity); ?></span>
                                                    <?php endif; ?>
                                                </span>
                                            </td>
                                            <td class="px-4 py-3 text-secondary-600">
                                                <?php echo e(\Carbon\Carbon::parse($borrowing->borrowed_at)->translatedFormat('d F Y H:i')); ?>

                                            </td>
                                            <td class="px-4 py-3 text-secondary-600">
                                                <?php echo e($borrowing->expected_return_at ? \Carbon\Carbon::parse($borrowing->expected_return_at)->translatedFormat('d F Y') : '-'); ?>
                                            ...
                                            <td class="px-4 py-3">
                                                <?php if($borrowing->status === 'borrowed'): ?>
                                                    <span class="bg-warning-100 text-warning-800 text-xs font-bold px-2 py-1 rounded-lg inline-flex items-center gap-1">
                                                        ...
                                                        <?php echo e(__('ui.status_borrowed')); ?>
                                                ...
                                                <?php elseif($borrowing->status === 'returned'): ?>
                                                    <span class="bg-success-100 text-success-800 text-xs font-bold px-2 py-1 rounded-lg inline-flex items-center gap-1">
                                                        ...
                                                        <?php echo e(__('ui.status_returned')); ?>
                                            ...
                                            <td class="px-4 py-3 text-right">
                                                <?php if(($borrowing->status === 'borrowed' || $borrowing->remaining_quantity > 0) && auth()->id() === $borrowing->user_id): ?>
                                                    <!-- Return Button -->
                                                    <button
                                                        type="button"
                                                        @click.stop="$dispatch('open-return-modal', { maxQty: <?php echo e($borrowing->remaining_quantity); ?>, borrowingId: <?php echo e($borrowing->id); ?> })"
                                                    ...
                                                    >
                                                        <span><?php echo e(__('ui.return_item')); ?></span>
                                                    </button>
                                                <?php else: ?>
                                                    <!-- View Evidence Button -->
                                                    <?php if($borrowing->return_evidence): ?>

                                                    <button 
                                                        type="button"
                                                        @click.stop="
                                                            activeEvidence = {
                                                                image: '<?php echo e(asset('storage/' . $borrowing->return_evidence)); ?>',
                                                                notes: '<?php echo e(addslashes($borrowing->return_notes ?? '-')); ?>',
                                                                date: '<?php echo e($borrowing->actual_return_date ? \Carbon\Carbon::parse($borrowing->actual_return_date)->translatedFormat('d F Y H:i') : '-'); ?>',
                                                                condition: '<?php echo e($borrowing->return_condition ?? 'Baik'); ?>'
                                                            };
                                                            evidenceModalOpen = true;
                                                        "
                                                        class="text-secondary-400 hover:text-primary-600 transition-colors tooltip-trigger z-10 relative"
                                                        title="<?php echo e(__('ui.view_return_evidence')); ?>"
                                                    >
                                                ...
                                                <?php if($borrowing->returns->count() > 0 || !(($borrowing->status === 'borrowed' || $borrowing->remaining_quantity > 0) && auth()->id() === $borrowing->user_id)): ?>
                                                    <a 
                                                        href="<?php echo e(route('inventory.borrow.show', $borrowing)); ?>"
                                                        @click.stop
                            ...
                            <div class="md:hidden space-y-4">
                                <?php $__currentLoopData = $borrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrowing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($canView): ?>
                                    <div class="bg-white border border-secondary-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-all cursor-pointer" onclick="window.location.href='<?php echo e(route('inventory.borrow.show', $borrowing)); ?>'">
                                        <!-- Header: User & Status -->
                                        <div class="flex items-start justify-between mb-3 border-b border-gray-100 pb-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 class="text-sm font-bold text-secondary-900"><?php echo e($borrowing->user->name ?? 'User Terhapus'); ?></h4>
                                                    <span class="text-xs text-secondary-500 block"><?php echo e($borrowing->user->role ?? '-'); ?></span>
                                                </div>
                                            </div>
                                            <div>
                                                 <?php if($borrowing->status === 'borrowed'): ?>
                                        ...
                                        <div class="grid grid-cols-2 gap-y-3 gap-x-4 text-sm mb-4">
                                            <div>
                                                <span class="text-[10px] text-secondary-400 block uppercase tracking-wider font-semibold"><?php echo e(__('ui.quantity')); ?></span>
                                                <div class="font-medium text-secondary-900 flex items-center gap-1">
                                                    <?php echo e($borrowing->quantity); ?> <?php echo e($sparepart->unit); ?>

                                                    <?php if($borrowing->remaining_quantity < $borrowing->quantity): ?>
                                                        <span class="text-xs text-secondary-500 font-normal bg-secondary-100 px-1.5 rounded">(Sisa: <?php echo e($borrowing->remaining_quantity); ?>)</span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div>
                                                <span class="text-[10px] text-secondary-400 block uppercase tracking-wider font-semibold"><?php echo e(__('ui.borrow_date')); ?></span>
                                                <span class="font-medium text-secondary-900"><?php echo e(\Carbon\Carbon::parse($borrowing->borrowed_at)->translatedFormat('d M Y')); ?></span>
                                            </div>
                                            <div class="col-span-2">
                                                <span class="text-[10px] text-secondary-400 block uppercase tracking-wider font-semibold"><?php echo e(__('ui.expected_return_date')); ?></span>
                                                <span class="font-medium text-secondary-900"><?php echo e($borrowing->expected_return_at ? \Carbon\Carbon::parse($borrowing->expected_return_at)->translatedFormat('d F Y') : '-'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-center justify-end border-t border-gray-100 pt-3 gap-3">
                                            ...
                                            <?php else: ?>
                                                ...
                                                >
                                                    ...
                                                    <span><?php echo e(__('ui.evidence')); ?></span>
                                                </button>
                                                <?php endif; ?>
                            ...
                            <?php else: ?>
                                <div class="text-center py-8 text-secondary-400 bg-secondary-50 rounded-lg border border-dashed border-secondary-200">
                                    ...
                                    <p class="text-sm"><?php echo e(__('ui.no_borrowing_history')); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                </div>
                ...
                <div class="col-span-1 lg:col-span-3">
                    <div class="card p-6">
                        <h3 class="text-lg font-bold text-secondary-900 mb-4 border-b border-secondary-100 pb-2 flex items-center justify-between">
                            <span><?php echo e(__('ui.similar_items')); ?></span>
                            <?php if(isset($similarItems) && $similarItems->count() > 0): ?>
                                <span class="text-xs font-normal text-secondary-500 bg-secondary-100 px-2 py-1 rounded-full"><?php echo e($similarItems->total()); ?> <?php echo e(__('ui.items_found')); ?></span>
                            <?php endif; ?>
                        </h3>
                        
                        <?php if(isset($similarItems) && $similarItems->count() > 0): ?>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            <?php $__currentLoopData = $similarItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('inventory.show', $item)); ?>" class="group block border border-secondary-200 rounded-xl hover:border-primary-500 hover:shadow-md transition-all duration-200 bg-white overflow-hidden">
                                <div class="flex items-start p-4 gap-4">
                                    ...
                                    <div class="flex flex-col gap-2 w-20 flex-shrink-0">
                                        <div class="w-20 h-20 bg-secondary-100 rounded-lg overflow-hidden relative">
                                            <?php if($item->image): ?>
                                                <img src="<?php echo e(asset('storage/' . $item->image)); ?>" loading="lazy" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                                            <?php else: ?>
                                        ...
                                        <div class="h-1 w-full rounded-full <?php echo e($item->type === 'sale' ? 'bg-success-600' : 'bg-primary-600'); ?>"></div>
                                    </div>
                                    
                                    <!-- Info -->
                                    <div class="flex-1 min-w-0">
                                        <h4 class="text-sm font-bold text-secondary-900 truncate group-hover:text-primary-600 transition-colors"><?php echo e($item->name); ?></h4>
                                        <p class="text-xs text-secondary-500 mb-2 truncate"><?php echo e($item->brand ?? __('ui.no_brand')); ?> • <?php echo e($item->category); ?></p>
                                        
                                        <div class="grid grid-cols-2 gap-y-1 gap-x-2 text-xs">
                                            <div>
                                                <span class="text-secondary-400 block text-[10px] uppercase"><?php echo e(__('ui.color')); ?></span>
                                                <span class="font-medium text-secondary-700"><?php echo e($item->color ?? '-'); ?></span>
                                            </div>
                                            <div>
                                                <span class="text-secondary-400 block text-[10px] uppercase"><?php echo e(__('ui.condition')); ?></span>
                                                <span class="font-medium text-secondary-700"><?php echo e($item->condition); ?></span>
                                            </div>
                                            <div>
                                                <span class="text-secondary-400 block text-[10px] uppercase"><?php echo e(__('ui.location')); ?></span>
                                                <span class="font-medium text-secondary-700 truncate"><?php echo e($item->location); ?></span>
                                            </div>
                                            <div>
                                                <span class="text-secondary-400 block text-[10px] uppercase"><?php echo e(__('ui.stock')); ?></span>
                                                <span class="font-bold <?php echo e($item->stock <= ($item->minimum_stock ?? 0) ? 'text-danger-600' : 'text-success-600'); ?>">
                                                    <?php echo e($item->stock); ?> <?php echo e($item->unit ?? 'Pcs'); ?>
                        ...
                        <?php else: ?>
                            <div class="text-center py-8 text-secondary-400 bg-secondary-50 rounded-lg border border-dashed border-secondary-200">
                                <svg class="w-10 h-10 mx-auto mb-2 text-secondary-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m-3-3v6m-9 1V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z"></path></svg>
                                    <p class="text-sm"><?php echo e(__('ui.no_similar_items')); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div x-show="returnModalOpen" 
                        ...
                        <div class="bg-white px-4 py-4 sm:px-6 border-b border-gray-200 flex-none z-10 shadow-sm">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-left">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                        <?php echo e(__('ui.return_item_title')); ?>
                        ...
                        <form :action="`/inventory/borrow/${selectedBorrowing}/return`" method="POST" enctype="multipart/form-data" class="flex flex-col flex-1 min-h-0" @submit.prevent="submitReturn">
                            ...
                            <div class="flex-1 overflow-y-auto px-4 pt-2 pb-4 sm:px-6 space-y-4 custom-scrollbar">
                                ...
                                <div x-show="Object.keys(errors).length > 0" class="mb-4 bg-danger-50 border border-danger-200 text-danger-700 px-4 py-3 rounded relative">
                                    <strong class="font-bold"><?php echo e(__('ui.save_failed')); ?></strong>
                                ...
                                <!-- Quantity -->
                                <div>
                                    <label for="return_qty" class="block text-sm font-medium text-gray-700"><?php echo e(__('ui.return_quantity')); ?> <span class="text-danger-500">*</span></label>
                                ...
                                <div @click.outside="dropdownOpen = false" class="relative z-50">
                                    <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('ui.condition')); ?> <span class="text-danger-500">*</span></label>
                                    <div class="relative">
            ...
            <div class="flex min-h-screen items-center justify-center py-12 px-4 sm:px-6">
                ...
                <div x-show="evidenceModalOpen" 
                    ...
                    <div class="bg-white px-4 py-4 sm:px-6 border-b border-gray-200 flex-none z-10 shadow-sm flex justify-between items-center">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                            <?php echo e(__('ui.return_evidence')); ?>
    ...
    <?php echo $__env->make('inventory.partials.alpine_script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php /**PATH E:\KULI AH\Semester\Semester 8\Tugas Akhir\Web 2\AzventoryWeb\resources\views/inventory/show.blade.php ENDPATH**/ ?>