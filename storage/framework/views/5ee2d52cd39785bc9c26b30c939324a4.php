        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-6">
                <h2 class="text-3xl font-bold text-secondary-900 tracking-tight">
                    <?php echo e(__('ui.create_inventory_title')); ?>

                </h2>
                <p class="mt-1 text-sm text-secondary-500"><?php echo e(__('ui.create_inventory_subtitle')); ?></p>
            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 col-span-full">
                                ...
                                <div>
                                    ...
                                    <div class="relative flex gap-2" x-data="{
                                        open: false,
                                        search: '',
                                        selected: '<?php echo e(old('part_number')); ?>',
...
<?php endif; ?>
                                ...
                                <div class="relative" x-data="{
                                    open: false,
                                    search: '',
                                    selected: '<?php echo e(old('category')); ?>',
...
<?php endif; ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 col-span-full" x-data="{ 
                                selectedAge: '<?php echo e(old("age", "")); ?>',
                                selectedCondition: '<?php echo e(old("condition", "")); ?>'
                                ...
                                <div class="relative" x-data="{
                                    ...
                                    init() {
                                        if (this.itemColor || '<?php echo e(old('color')); ?>') {
                                            this.selected = this.itemColor || '<?php echo e(old('color')); ?>';
                                            this.search = this.selected;
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <input id="minimum_stock" class="input-field" type="number" name="minimum_stock" value="<?php echo e(old('minimum_stock', 5)); ?>" min="0" @keypress="if(!/[0-9]/.test($event.key)) $event.preventDefault()" />
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <input id="stock" class="input-field" type="number" name="stock" value="<?php echo e(old('stock')); ?>" min="0" @keypress="if(!/[0-9]/.test($event.key)) $event.preventDefault()" />
                                <?php if (isset($component)) { $__componentOriginal824404ceeb4a1e7de17bfcaedf377360 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal824404ceeb4a1e7de17bfcaedf377360 = $attributes; } ?>
<?php $component = App\View\Components\InputError::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div x-show="type === 'sale'" x-data="{
                                ...
                                <div class="relative">
                                    ...
                                    <input 
                                        id="price" 
                                        class="input-field pl-10 <?php echo e(auth()->user()->role === \App\Enums\UserRole::ADMIN ? 'bg-gray-100 text-gray-500 cursor-not-allowed' : ''); ?>" 
                                        type="text" 
                                        ...
                                        placeholder="0" 
                                        autocomplete="off"
                                        <?php echo e(auth()->user()->role === \App\Enums\UserRole::ADMIN ? 'readonly' : ''); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select','data' => ['name' => 'status','options' => $statusOptions,'selected' => old('status', 'aktif'),'placeholder' => ''.e(__('ui.select_status')).'','width' => 'w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'status','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($statusOptions),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('status', 'aktif')),'placeholder' => ''.e(__('ui.select_status')).'','width' => 'w-full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <div class="flex items-center justify-end gap-3 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <?php echo e(__('ui.save_sparepart')); ?>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('inventoryForm', () => ({
                type: '<?php echo e(old('type', 'sale')); ?>',
                partNumber: '<?php echo e(old('part_number')); ?>',
                isLocked: false,
                itemName: '<?php echo e(old('name')); ?>',
                itemBrand: '<?php echo e(old('brand')); ?>',
                itemCategory: '<?php echo e(old('category')); ?>',
                itemColor: '<?php echo e(old('color')); ?>', 
                itemUnit: '<?php echo e(old('unit', 'Pcs')); ?>',
                itemPrice: '<?php echo e(old('price')); ?>',
                imagePreview: null,
                ...
                async checkPN() {
                    ...
                    this.isLoading = true;
                    try {
                        const response = await axios.get('<?php echo e(route("inventory.check-part-number")); ?>', {
...
<?php endif; ?>
<?php /**PATH E:\KULI AH\Semester\Semester 8\Tugas Akhir\Web 2\AzventoryWeb\resources\views/inventory/create.blade.php ENDPATH**/ ?>