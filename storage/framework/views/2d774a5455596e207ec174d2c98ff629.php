...
<head>
    ...
    <title>Label - <?php echo e(\Illuminate\Support\Str::title($sparepart->category)); ?> - <?php echo e(strtoupper($sparepart->part_number)); ?></title>
...
<body class="bg-gray-100">
    ...
    <div id="toolbar" class="print:hidden">
        <div class="flex flex-col">
            ...
            <p class="text-xs text-gray-400"><?php echo e($sparepart->name); ?> (<?php echo e($sparepart->part_number); ?>)</p>
        </div>
    ...
    <template id="label-template">
        <div class="label-item">
            <div class="qr-section">
                <img src="<?php echo e(asset('storage/' . $sparepart->qr_code_path)); ?>" alt="QR" class="qr-image">
            </div>
            <div class="info-section">
                <div class="label-title">Part Number</div>
                <div class="label-content part-number"><?php echo e($sparepart->part_number); ?></div>
                <div class="label-text"><?php echo e($sparepart->name); ?></div>
            </div>
        </div>
    </template>
...
<?php /**PATH E:\KULI AH\Semester\Semester 8\Tugas Akhir\Web 2\AzventoryWeb\resources\views/inventory/print_label.blade.php ENDPATH**/ ?>